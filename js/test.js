...
$(".language_ru").click(() => {
    ...
    $(".menu_btn4").text("магазин скорости восстановления энергии");
    $(".language4").text("количество денег за 1 энергию: ");
    $(".language5").text("восстановление энергии в миллисекундах: ");
});
$(".language_en").click(() => {
    language = "en";
